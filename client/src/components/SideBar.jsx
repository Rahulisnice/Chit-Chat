  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="text-sm flex felx-col">
          <p>Community Pages</p>
        </div>
      </div>
      ...
      >
        ...
        <div className="flex flex-col text-sm ">
          ...
          <p className="text-xs text-gray-400">
            Purchase credits to use chitchat
          </p>
        </div>
      </div>

      {/* dark mode toggle */}
      <div className="flex justify-between items-center gap-2 p-3 mt-4 border border-gray-300 dark:border-white/15 rounded-md">
      ...
      {/* close sidebar for mobile users */}
      <img
